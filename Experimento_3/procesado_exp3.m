...
mostrar_graficas.bot = true;    % Muestra las gráficas de la capa inferior
mostrar_graficas.mid = false;   % Muestra las gráficas de la capa media
mostrar_graficas.up  = false;   % Muestra las gráficas de la capa superior
mostrar_graficas.individuales = false; % Gráfica extra por cada una de las 4 ventanas
